...
- `{project-root}/_gary-the-gardener/garden/docsmap.yaml` — exists? If yes, read entity count and count seeds vs plants across all areas; read `project_summary` if present — use to frame suggestions with project context
